...
class Club(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("shop:club_detail", kwargs={"pk": self.pk})
...
class Brand(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("shop:brand_detail", kwargs={"pk": self.pk})
...
class Supplier(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("shop:supplier_detail", kwargs={"pk": self.pk})
